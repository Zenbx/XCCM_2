...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm border-b border-gray-100 dark:border-gray-800 fixed top-0 left-0 right-0 z-[9999]">
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 py-2 z-[110]"
                >
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-[280px] bg-white shadow-2xl z-[120] flex flex-col lg:hidden overflow-y-auto"
            >
