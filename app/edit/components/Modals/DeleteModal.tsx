...
const DeleteModal: React.FC<DeleteModalProps> = ({ config, onClose, onConfirm }) => {
    const trapRef = useFocusTrap(config.isOpen);
        ...
        <AnimatePresence>
            {config.isOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-6">
                            <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mb-4" aria-hidden="true">
                                <Trash2 className="text-red-600" size={24} />
                            </div>
                            <h3 id="delete-modal-title" className="text-xl font-bold text-gray-900 mb-2">Confirmer la suppression</h3>
