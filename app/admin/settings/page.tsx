    ...
    return (
        <div className="space-y-10 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="bg-[#99334C] text-white px-8 py-4 rounded-2xl font-bold flex items-center gap-3 hover:scale-105 shadow-xl shadow-[#99334C]/20 transition-all">
                ...
                <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        type="text"
                                        defaultValue="XCCM 2 - Enterprise"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <input
                                        type="text"
                                        defaultValue="https://support.xccm2.com"
                                        className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:ring-2 focus:ring-[#99334C]/20 font-bold text-gray-900"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <textarea
                                    rows={4}
                                    defaultValue="La plateforme de composition de cours la plus avancée du marché."
                    ...
                    <div className="bg-[#36454F] rounded-[32px] p-8 md:p-10 text-white relative overflow-hidden group">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                            {[
                                { label: '2FA Obligatoire pour Admins', status: true },
                                { label: 'Logs de connexion détaillés', status: true },
                                { label: 'Expiration session (24h)', status: false },
                                { label: 'Whitelist IP', status: false },
                            ].map((sec, i) => (
                    ...
                    <div className="flex justify-end gap-4">
                        <button className="px-8 py-4 bg-gray-100 text-gray-500 rounded-2xl font-bold hover:bg-gray-200 transition-all">
                            Réinitialiser
                        </button>
                        <button className="px-8 py-4 bg-[#99334C] text-white rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-[#99334C]/20 hover:scale-105 transition-all">
                            <RefreshCcw className="w-5 h-5" />
                            Déployer Changements
                        </button>
                    </div>
                </div>
            </div>
