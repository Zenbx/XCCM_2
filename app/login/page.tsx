          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                disabled={isLoading}
                className="w-4 h-4 rounded border-gray-300 text-[#99334C] focus:ring-[#99334C]/20 disabled:cursor-not-allowed"
              />
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-[#99334C] text-white py-3 rounded-xl font-semibold hover:bg-[#7a283d] transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
