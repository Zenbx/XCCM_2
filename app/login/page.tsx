...
const LoginPage = () => {
  ...
  const [oauthLoading, setOauthLoading] = React.useState<'google' | 'microsoft' | null>(null);
  ...
  return (
    <div className="min-h-screen flex selection:bg-[#99334C]/30 selection:text-[#99334C]">
        ...
        <div className={`relative z-10 flex flex-col justify-between p-12 text-white w-full transition-all duration-700 ease-out delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          ...
          <div className="max-w-md">
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              {t('welcomeBack').split('!')[0]}<br />{t('welcomeBack').includes('!') ? '!' : ''}
            </h1>
          ...
          <form noValidate onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                disabled={isLoading}
                className="w-4 h-4 rounded border-gray-300 dark:border-gray-700 text-[#99334C] focus:ring-[#99334C]/20 disabled:cursor-not-allowed cursor-pointer"
              />
              <label htmlFor="remember" className="ml-2 text-sm text-gray-700 dark:text-gray-400 cursor-pointer hover:text-gray-900 dark:hover:text-white transition-colors">
                {t('rememberMe')}
              </label>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-950 text-gray-500 dark:text-gray-400">{t('orContinueWith')}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="hidden sm:inline">{oauthLoading === 'google' ? 'Redirection…' : 'Google'}</span>
              </button>
              ...
              >
                ...
                <span className="hidden sm:inline">{oauthLoading === 'microsoft' ? 'Redirection…' : 'Microsoft'}</span>
              </button>
            </div>
            ...
            <div className="text-center">
              <Link
                ...
                className="text-sm text-[#99334C] dark:text-[#ff9daf] hover:underline font-medium"
              >
                {t('forgotPassword')}
              </Link>
            </div>
            ...
            <div className="text-center pt-4 border-t border-gray-200 dark:border-gray-800">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('noAccount')}{' '}
                <a href="/register" className="text-[#99334C] dark:text-[#ff9daf] hover:underline font-semibold">
                  {t('createAccount')}
                </a>
              </p>
            </div>
